...
class downloadFsaverageMneDataListener(ABC):
    """
    Listener doing the connection between the controller and the view for downloading the mne sample and fsaverage datasets.
