...
class studyPowerSpectralDensityWorkerSignals(QObject):
    """
...
class studyPowerSpectralDensityRunnable(QRunnable):
    def __init__(self, file_data, minimum_frequency, maximum_frequency, minimum_time, maximum_time, topo_time_points):
        ...
        """
        super().__init__()
        self.signals = studyPowerSpectralDensityWorkerSignals()
